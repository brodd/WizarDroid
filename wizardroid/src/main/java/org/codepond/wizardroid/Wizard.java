...
public class Wizard implements Disposable, Subscriber {
  ...
  public Wizard(final WizardFlow wizardFlow,
    ...
    //FragmentManager pagerFragmentManager = null;
    if (callbacks instanceof Fragment) {
      mFragmentManager = ((Fragment) callbacks).getChildFragmentManager();
    }
    else mFragmentManager = activity.getSupportFragmentManager();
    ...
    mPager.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
      ...
      public void onPageSelected(int position) {
        if (backStackEntryCount < position){
          mFragmentManager.beginTransaction().addToBackStack(null).commitNowAllowingStateLoss();
        }
